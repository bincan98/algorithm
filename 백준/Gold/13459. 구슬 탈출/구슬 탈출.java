...
public class Main {
    ...
    private static int N, M, oriRedY, oriRedX, oriBlueY, oriBlueX, result, possible;
    ...
    public static void main(String[] args) throws IOException {
        ...
        possible = 0;
        recur(0, new int[] {oriRedY, oriRedX}, new int[] {oriBlueY, oriBlueX});

        System.out.println(possible);

    } // end of main

    private static void recur(int cur, int[] redPosition, int[] bluePosition) {
        if (cur == 10 || possible == 1) return;
        result = -1;
        ...
        for (int i = 0; i < 4; i++) {
            ...
            recur(cur + 1, nextRedPosition, nextBluePosition);
        }
    } // end of recur
